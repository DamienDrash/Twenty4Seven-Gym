...
function setMessage(text, type = "") {
  ...
  // Update only the message area instead of full render if it exists
...
async function updateBrandingLogoLink(event) {
  // Deprecated by updateBrandingColors saving it too, but kept for compatibility if called
  updateBrandingColors(event);
}
  ...
  if (editorEl && typeof Quill !== "undefined") {
    ...
    const updatePreview = () => {
      ...
      if (state.emailTemplate) {
        state.emailTemplate.access_code_body_html = content;
      }
        ...
        <div class="editor-shell">
          <div class="editor-workspace">
            ...
            <div class="stack mt-24">
              ...
              <div class="placeholder-chip-container">
                ...
                <button class="placeholder-chip" data-insert="{member_name}">Mitgliedsname</button>
                <button class="placeholder-chip" data-insert="{code}">Zugangscode</button>
                <button class="placeholder-chip" data-insert="{valid_from}">Gültig ab</button>
                <button class="placeholder-chip" data-insert="{valid_until}">Gültig bis</button>
                <button class="placeholder-chip" data-insert="{check_in_url}">Check-In Button</button>
              </div>
            </div>
          ...
          <div class="editor-preview-pane">
            <div class="preview-controls">
              <button class="preview-toggle active" data-mode="desktop">Desktop</button>
              <button class="preview-toggle" data-mode="mobile">Mobil</button>
            </div>
